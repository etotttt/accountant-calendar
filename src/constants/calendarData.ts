...
export const staticCalendarData: StaticData = {
    ...
    2025: {
        holidays: {
            ...
            '2025-05-02': 'Выходной (перенос с 04.01)',
            '2025-05-08': 'Выходной (перенос с 23.02)',
            '2025-05-09': 'День Победы',
            '2025-06-12': 'День России',
            '2025-06-13': 'Выходной (перенос с 08.03)',
            '2025-11-03': 'Выходной (перенос с 01.11)',
            '2025-11-04': 'День народного единства',
            '2025-12-31': 'Выходной (перенос с 05.01)'
        },
        shortDays: {
